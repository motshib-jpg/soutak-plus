(() => {
  ...
  if (header) header.innerHTML = `<header class="site-header" id="header"><div class="container nav">
    ...
    <div class="nav-actions"><a class="btn primary" href="index.html#newsletterForm">انضم الآن</a><button class="mobile-btn" id="mobileBtn">☰</button></div>
  </div></header>`;
  ...
  if (window.SOUTAK_CONFIG?.analyticsEnabled && window.SoutakDB?.enabled && navigator.doNotTrack !== "1") {
    ...
    window.SoutakDB.client.rpc("track_event_public",{p_event_name:"page_view",p_path:location.pathname,p_referrer:document.referrer||null,p_session_id:sid,p_metadata:{page}})
      .then(()=>{}).catch(()=>{});
  }
})();
